<div class="py-12 max-w-7xl mx-auto adaptable-container content-start">
    @if (count($boards) > 0)    
        ...
        <div>
            ...
            <div class="flex">
                <a href="{{ route('boardEdit', ['id' => $board->id]) }}" class="border border-gray-400 bg-gray-200 hover:bg-gray-400 cursor-pointer w-full h-fit text-center px-4 py-2 flex justify-center gap-4 place-items-center">
                    Modificar
                </a>
        ...
        @endforeach
    @else
        <div class="text-center text-3xl text-gray-400">No hay proyectos...</div>        
    @endif
